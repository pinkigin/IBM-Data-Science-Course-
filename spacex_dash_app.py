...
def update_piegraph(site_dropdown):
    if (site_dropdown == 'All Sites' or site_dropdown == 'None'):
        ...
        # Define the mapping for the class labels
        class_mapping = {0: 'Failure', 1: 'Successful'}
      # Replace class values with their corresponding labels
